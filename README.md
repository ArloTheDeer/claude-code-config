...
將所有 Skills 安裝到 Claude Code 環境：

```bash
# 首次安裝
npm run install-config

# 強制覆蓋現有 Skills（注意 -- 和 overwrite 之間需要空格）
...
安裝時會自動清理舊版本的 commands 和 agents（如果存在）。
...
- **📂 Skills 目錄結構：** 採用 Claude Code Skills 格式，支援檔案拆分和漸進式揭露
